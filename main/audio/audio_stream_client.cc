...
ESP_LOGI(
    TAG,
    "Audio task free stack before stream: %u bytes",
...
size_t length
          ...
          // Server GeniusAI mengirim Opus mono 16 kHz,
// jadi jangan memakai metadata Ogg yang kadang bernilai 48 kHz.
packet->sample_rate = 16000;
packet->frame_duration = 60;
            packet->timestamp = timestamp;
            packet->genius_media = true;
